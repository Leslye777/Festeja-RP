		...
		<div class="main_wrapper">
			...
			<div class="content_wrapper">
				<div id="sidebar">
					...
					<div align="center" style="padding-top: 24px;"><button id="sidebar_title" onclick="Mudarestado('cats')" style="width:350px; height: 70px;background-image: url('imagens/titleCAT.png');background-size: 350px 70px; border:none;">Categorias</button></div>
					<ul id="cats" class="hidden">
						<?php getCateg(); ?>
					</ul>
								
					<div align="center" style="padding-top: 12px;"><button id="sidebar_title" onclick="Mudarestado('forn')" style="width:350px; height: 70px;background-image: url('imagens/titleFORN.png');background-size: 350px 70px; border:none;">Organizadores</button></div>
					<ul id="forn" class="hidden">
						<?php getForn(); ?>
					</ul>
